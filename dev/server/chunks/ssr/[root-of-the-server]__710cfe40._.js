...
"[project]/lib/pose-utils.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$pose$2d$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/pose-utils.ts [app-ssr] (ecmascript)");
    ...
    const startWebcam = async ()=>{
        ...
        try {
            ...
            if (!detectorRef.current) {
                const detector = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$pose$2d$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initializePoseDetector"])();
                if (!detector) {
    ...
    const startPoseDetectionLoop = ()=>{
        const detect = async ()=>{
            ...
            try {
                ...
                if (detectorRef.current) {
                    pose = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$pose$2d$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["detectPose"])(videoRef.current);
                }
                if (pose) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__710cfe40._.js.map